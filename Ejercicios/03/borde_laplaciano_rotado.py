...
for i in range(1, largo-1):
    for j in range(1, ancho-1):
        ...
        color = -1*pixel_esq_izq_arr-pixel_esq_der_arr+4*pixel_actual-pixel_esq_der_aba-pixel_esq_izq_aba  
        color = abs(color)
...
plt.title("Detección de borde gradiente rotado")
